...
| 3 | `plantilla-rotulo` — hoja CSS, hero, periferia, tests de humo, Loop B, ficha | visual, Loop B | 1a, 1b, 2 | 🟡 **en curso** · cartel y hoja CSS hechos (12-sep); faltan periferia, banda de papel, script y Loop B | se planifica al cerrar 2 (`/mm-plan plantilla-rotulo`) |
