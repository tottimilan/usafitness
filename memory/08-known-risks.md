...
| 3 | **Duplicated reviews across legally independent stores** — the SAME THREE AUTHORS (Hiba de la Iglesia Moreno, Amaya Guerra, Andrea García) sign reviews in Marineda, Las Rosas AND Vigo; Andrea García also in Villanueva. In Marineda and Las Rosas the text is identical word for word; one copied review mentions a Sunday shift at a store that closes Sundays | Medium | High | Collect genuine per-store reviews; remove filler | Open |
