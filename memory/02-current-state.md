...
**Siguiente:** rodaja 1c (modelo de ofertas) y luego las secciones de generación 2, que ya sí pasan por la puerta visual del dueño. Las secciones de generación 2 y la plantilla en sí vienen después, y esas sí pasan por la puerta visual del dueño. (espacio → 5 diseñadores → 10 críticos → prueba de la miniatura → síntesis).
