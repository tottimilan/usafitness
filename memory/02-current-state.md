...
**Siguiente:** rodaja 1d (`franjaDeHoy` + festivos por centro, que devuelve el minutero) o 1c (modelo de ofertas). Las secciones de generación 2 y la plantilla en sí vienen después, y esas sí pasan por la puerta visual del dueño. (espacio → 5 diseñadores → 10 críticos → prueba de la miniatura → síntesis).
