...
>
> **What this is.** The operational manual for the template. It explains how the 26 skills, 7 workflows, 17 slash commands, 10 rules, 15 memory files, hooks, scripts, and MCPs coordinate across the seven project phases (Idea → Discovery → Definition → Prototype → MVP → Iteration → Launch; Prototype is optional for non-UI projects). It shows which component runs when, why, and what to do when the plan no longer fits reality.
>
...
- `.cursor/rules/usafitness-project.mdc` — project-specific rule (predates MASTERMIND; kept active)
