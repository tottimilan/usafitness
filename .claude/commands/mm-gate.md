...
Arguments: $ARGUMENTS (the target phase — one of: Discovery, Definition, MVP, Iteration, Launch)

Execute the workflow at `.claude/workflows/04-phase-gate-transition.md`.

Steps:

1. Validate `$ARGUMENTS` is one of: `Discovery`, `Definition`, `MVP`, `Iteration`, `Launch`. Otherwise ask.
